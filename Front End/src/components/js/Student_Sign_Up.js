...
import '../css/Student_Sign_Up.css';
...
validate = (event) => {
  ...
  if(this.state.student_type === ""){
    errors.student_type = ' * required'
  }

  if(this.state.grade_or_year === ""){
    errors.grade_or_year = ' * required'
  }
  ...
  if(isNaN(this.state.grade_or_year)){
    errors.grade_or_year = "* grade/year should be an integer";
  }
  else if(this.state.student_type === "UNI" && (this.state.grade_or_year >4 || this.state.grade_or_year<1) ){
    errors.grade_or_year = "* year should be between 1 and 4"
  }
  else if(this.state.student_type === "SCL" && (this.state.grade_or_year <6 || this.state.grade_or_year>13) ){
    errors.grade_or_year = "* grade should be between 6 and 13"
  }
...
handleSubmit = (event) => {
  ...
  if(this.isValid(this.state.errors)){
      ...
      this.state.email, this.state.age, this.state.gender, this.state.grade_or_year, this.state.phone_number, this.state.student_type,this.state.password);
...
insertUser = (event, first_name, mid_name, last_name, email, age, gender, grade_or_year, phone_number, student_type, password) => {
  event.persist();
  Axios.post('http://localhost/Wisdomex/Back End/Register/add-student.php', {
    ...
    return ( 
      <div className="back1">
        ...
        <div className="signup-form">
            <form onSubmit = {this.validate} id = "student_reg_form"> 
            <h2>Register</h2>
            <p className="hint-text">Create your student account</p>
              ...
              <div className="row">
                  <div className="col">
                      <input type="text" className="form-control" name="age" placeholder="Age" 
                        ...
                        <small className="text-danger d-flex justify-content-between">{this.state.errors.age}</small>
                  </div>
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <small className="text-danger d-flex justify-content-between">{this.state.errors.student_type}</small>
            </div>
            ...
            <div className="form-group">
                <div className="row">
                    <div className="col">
                      <input type="text" className="form-control" name="grade_or_year" placeholder="Grade/Year"
                        value={this.state.grade_or_year} onChange={this.handleChange}/>
                        <small className="text-danger d-flex justify-content-between">{this.state.errors.grade_or_year}</small>
                    </div>
                </div>        	
            </div>
      ...
      <div className="text-center">Already have an account? <Link to='Student_Login_Page'>Sign in</Link></div>
  </div>
