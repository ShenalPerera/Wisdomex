...
// import insertUser from '../../Actions/Login/Student_Login';
...
export default class Student_Login_Page extends Component {
    ...
    insertUser = (event,Email, Password) => {
        event.persist();
        Axios.post('http://localhost/Wisdomex/Back End/Login/login-student.php',{
                Email:Email,
                Password:Password
            },
            {headers: {
                ...
                <div className = "signup-form">
                    <form id="form_login" onSubmit={this.mySubmitHandler}>
                        ...
                        <p className="new-user_sign_up">
                            New User? <Link to='Student_SignUp_Page'>Sign Up</Link>
                        </p>
