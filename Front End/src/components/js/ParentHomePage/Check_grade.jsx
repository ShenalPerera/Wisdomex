...
export class Check_grade extends Component{
    ...
    componentDidMount() {
        this.getGrades(this.state.student_id);
        this.getStrGrades(this.state.student_id);
      }
    ...
    return(
                    ...
                    <ul className="font-weight-bold">
                        <li>
                            <DomLink
                                className="link"
                                activeClass="true"
                                to={`/Parent_Home_Page/${this.state.id}`}
                                spy={true}
                                smooth={true}
                                offset={-70}
                                duration={500}
        ...
        <footer className=" mt-5 fixed-bottom page-footer font-small special-color-dark pt-3 pb-3">
            ...
            <div className="credits d-flex justify-content-center">
                Designed by &nbsp; <a href={`/Parent_Home_Page/${this.state.id}`}>Wisdomex.com</a>
            </div>
        </footer>
